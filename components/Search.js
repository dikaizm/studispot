export default function Search() {
    return (
        ...
        <div className="relative w-full">
            <input type="search" id="search-dropdown" className="block p-3 sm:p-4 w-full z-20 text-sm text-gray-800 bg-white rounded-r-full border-l-gray-100 border-l-2 border border-spotBlue placeholder-gray-400" placeholder="Pelajari hal baru..." required />
            <button type="submit" className="absolute top-0 right-0 p-3 sm:p-4 text-sm font-medium text-white bg-spotBlue rounded-r-full border border-blue-700 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300"><svg aria-hidden="true" className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg></button>
        </div>
    </div>
</form>
    )
