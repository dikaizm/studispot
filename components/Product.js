...
function ProductItem({ icon, name, desc, buttonColor }) {
    const addIcon = ` ${icon}`
    ...
    return (
        <div class="relative flex flex-col items-center bg-white max-w-[350px] h-[480px] drop-shadow-xl rounded-8xl">
            ...
            <h3 class="text-2xl text-spotBlue font-bold text-center">{name}</h3>
            <p class="text-center text-slate-500 max-w-[280px] pt-5">{desc}</p>
